...
/**
 * @description Filehandler is a utility to add, remove and update data to a file
 * @params data: data to be added/updated or removed, option: create/edit/delete
 * @return void
 */
const addNoteInFile = (data) => {
};
